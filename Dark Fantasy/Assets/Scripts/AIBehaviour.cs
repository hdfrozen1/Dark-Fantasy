...
public class AIController : MonoBehaviour
{
    ...
    // if player is near enemy, stop and looking for player
    // else , Just patrol with giving points
    ...
    // make enemy go to last player position if it hearing some noise from player.
    // if distance with last player position < 0.3 wait a second and come back to patrol
    ...
    // create a field of view to detect player, if player is in field of view and not blocked by obstacle, enemy will chase player.
    // While player still in field of view, store position of player to chase.
    // If player is out of field of view, stop chasing
    void EnviromentView()
    {
